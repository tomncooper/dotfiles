...
# c.InteractiveShellApp.code_to_run = 'export PYTHONBREAKPOINT=ipdb.set_trace'
...
c.InteractiveShellApp.exec_lines.append("%env PYTHONBREAKPOINT=ipdb.set_trace")
...
## Auto-Reload modules when the source code changes
